...
namespace RSAEncryptDecrypt
{
    public class RSAService
    {
        ...
        /// <returns></returns>
        string ExportPrivateKey(RSACryptoServiceProvider csp)
        {
        ...
        public string EncryptText(string plainText, string publicKey)
        {
            try
            {
                RSAParameters pubKey = ImportPublicKey(publicKey);
              
                var csp = new RSACryptoServiceProvider((int)Enums.dwKeySize);
        ...
        public string DecryptText(string cypherText, string privateKey)
        {
            try
            {
                RSAParameters privKey = ImportPrivateKey(privateKey);
